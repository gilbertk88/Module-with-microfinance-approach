<?php 
class mgrIssueNotification extends Notification{
	// Path to Web View of this Notification
	public $webView = "accounting.views.notifications.mgrIssueReceipient";
	
	// Path to Mail Template for this notification
	public $mailView = "application.modules.accounting.views.notifications.mgrIssueReceipient_mail";
	...
	public static  function fire($userData){
		...
		$notification->class = "mgrIssueNotification";
