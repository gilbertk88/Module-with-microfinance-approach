<?php 
class shareBuyNotification extends Notification{
	// Path to Web View of this Notification
	public $webView = "accounting.views.notifications.shareBuy";
	
	// Path to Mail Template for this notification
	public $mailView = "application.modules.accounting.views.notifications.shareBuy_mail";
	...
	public static  function fire($userData){
		...
		$notification->class = "shareBuyNotification";
