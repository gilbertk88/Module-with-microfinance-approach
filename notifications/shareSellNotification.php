<?php 
class shareSellNotification extends Notification{
	// Path to Web View of this Notification
	public $webView = "accounting.views.notifications.shareSell";
	
	// Path to Mail Template for this notification
	public $mailView = "application.modules.accounting.views.notifications.shareSell_mail";
	...
	public static  function fire($userData){
		...
		$notification->class = "shareSellNotification";
