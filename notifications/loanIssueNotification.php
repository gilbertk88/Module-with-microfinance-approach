<?php 
class loanIssueNotification extends Notification{
	// Path to Web View of this Notification
	public $webView = "accounting.views.notifications.loanIssue";
	
	// Path to Mail Template for this notification
	public $mailView = "application.modules.accounting.views.notifications.loanIssue_mail";
	...
	public static  function fire($userData){
		...
		$notification->class = "loanIssueNotification";
