...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="">
		<div class="">
			...
			<?php 	echo CHtml::activeHiddenField($model,'transaction_direction',array('value'=>$shareData['trans_dir'])); ?>
			<?php 	echo CHtml::activeHiddenField($model,'type_unit',array('value'=>$shareData['trans_dir'])); ?>
		...
		<div class="">
			<?php 
				echo CHtml::label('Number of shares to issue to member','',''); 
			?>
		...
		<div class="">
			<?php 
			echo CHtml::label('Total amount to be paid by member','','');
			 echo $form->numberField($model,'amount',array('class' => 'form-control','readonly'=>true)); ?>
