...
<?php	
echo CHtml::link(CHtml::htmlButton('Individual Reports',array('class'=>'individualreport pull-right btn btn-primary')),array('//space/mlist/reports','sguid'=>$space->guid));
...
<center class="reporthead"><h1><b><?php echo CHtml::label(CHtml::encode('Whole  SACCO Report'),'',''); ?></b></h1></center>
<div class="col-md-12">
<hr class="col-md-11">
	...
	<table class= "col-md-6">
		<thead>
			<td><center><h1><?php echo CHtml::label(CHtml::encode('Money Balance'),'',''); ?></h1></center></td>
		</thead>
		<tr class="">
				<td><?php echo CHtml::label(CHtml::encode('Cash Bal  :'),'',''); ?></td>		
				<td>
				<b><?php 
				echo CHtml::encode(Yii::app()->format->number($data['cash'])); ?></b>
				</td>
		</tr>
		<tr class="">
				<td><?php echo CHtml::label(CHtml::encode('Bank Bal :'),'',''); ?></td>		
				<td>
				<b><?php 
				echo CHtml::encode(Yii::app()->format->number($data['bank'])); ?></b>
				</td>
		</tr>
		<tr class="">
				<td><?php echo CHtml::label(CHtml::encode('Mobile Bal :'),'',''); ?></td>		
				<td>
				<b><?php 
				echo CHtml::encode(Yii::app()->format->number($data['mobile'])); ?></b>
				</td>			
