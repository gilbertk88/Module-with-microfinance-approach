...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="">
		...
		<div class="">
			<?php $amounttitle='Amount - available balance ('.$mgrIdRoundCycle['availableAmountFund'].')';
				echo CHtml::label(Chtml::encode($amounttitle),'','');  ?>
		...
		<br>
		<div class=" buttons">
			<?php echo CHtml::submitButton($model->isNewRecord ? 'Issue from fund' : 'Save', array('class'=> 'btn btn-primary' )); ?>
		</div>
	</div>
