...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="">
		...
		<?php //@todo review issue when content of database is not reflected on the database ?>
		 ...
		 <?php 	echo CHtml::activeHiddenField($model,'trans_type_id',array('value'=> $loanData['setting'])); ?>
		 <?php 	echo CHtml::activeHiddenField($model,'type_unit',array('value'=>'1')); ?>
		 <?php  echo CHtml::activeHiddenField($model,'type_subunit',array('value'=>'1')); ?>		 
	<div class="">
	...
	<div class="">
		...
		<br>
	<div class=" buttons">
			<?php echo CHtml::submitButton($model->isNewRecord ? 'Issue' : 'Save', array('class'=> 'btn btn-primary' )); ?>
	</div>
</div>
